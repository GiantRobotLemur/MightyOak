...
const CoreTestParams basicAlu[] = {
    ...
    { TLOC, "SUBS_NoFlags", "R0=2,Status=0", "R0=2,R1=1,Status=C", "SUBS R1,R0,#1" },
    { TLOC, "SUBS_Overflow", "R0=0x80000000,Status=0", "R0=0x80000000,R1=0x7FFFFFFF,Status=CV", "SUBS R1,R0,#1" },
    { TLOC, "SUBS_Carry", "R0=0xFFFFFFFF,R1=0,Status=0", "R0=0xFFFFFFFF,R1=0,R2=1,Status=0", "SUBS R2,R1,R0" },
    { TLOC, "SUBS_Zero", "R0=1,Status=0", "R0=1,R1=0,Status=ZC", "SUBS R1,R0,#1" },
    { TLOC, "SUBS_Negative", "R0=0,Status=0", "R0=0,R1=0xFFFFFFFF,Status=N", "SUBS R1,R0,#1" },
    ...
    { TLOC, "RSBS_NoFlags", "R0=1,Status=0", "R0=1,R1=1,Status=C", "RSBS R1,R0,#2" },
    { TLOC, "RSBS_Overflow", "R0=1,Status=0", "R0=1,R1=0x7FFFFFFF,Status=CV", "RSBS R1,R0,#&80000000" },
    { TLOC, "RSBS_Carry", "R0=0xFFFFFFFF,R1=0,Status=0", "R0=0xFFFFFFFF,R1=0,R2=1,Status=0", "RSBS R2,R0,R1" },
    { TLOC, "RSBS_Zero", "R0=1,Status=0", "R0=1,R1=0,Status=ZC", "RSBS R1,R0,#1" },
    { TLOC, "RSBS_Negative", "R0=1,Status=0", "R0=1,R1=0xFFFFFFFF,Status=N", "RSBS R1,R0,#0" },

    // SBC
    { TLOC, "SBC_NoFlagsCC", "R0=2,Status=0", "R0=2,R1=0,Status=0", "SBC R1,R0,#1" },
    { TLOC, "SBC_NoFlagsCS", "R0=3,Status=C", "R0=3,R1=2,Status=C", "SBC R1,R0,#1" },
    { TLOC, "SBC_Overflow", "R0=0x80000000,Status=0", "R0=0x80000000,R1=0x7FFFFFFE,Status=0", "SBC R1,R0,#1" },
    { TLOC, "SBC_Carry", "R0=0xFFFFFFFF,R1=0,Status=0", "R0=0xFFFFFFFF,R1=0,R2=0,Status=0", "SBC R2,R1,R0" },
    { TLOC, "SBC_Zero", "R0=1,Status=0", "R0=1,R1=0xFFFFFFFF,Status=0", "SBC R1,R0,#1" },
    { TLOC, "SBC_Negative", "R0=0,Status=0", "R0=0,R1=0xFFFFFFFE,Status=0", "SBC R1,R0,#1" },
    { TLOC, "SBCS_NoFlagsCC", "R0=2,Status=0", "R0=2,R1=0,Status=ZC", "SBCS R1,R0,#1" },
    { TLOC, "SBCS_NoFlagsCS", "R0=3,Status=C", "R0=3,R1=2,Status=C", "SBCS R1,R0,#1" },
    { TLOC, "SBCS_Overflow", "R0=0x80000000,Status=0", "R0=0x80000000,R1=0x7FFFFFFE,Status=CV", "SBCS R1,R0,#1" },
    { TLOC, "SBCS_Carry", "R0=0xFFFFFFFF,R1=0,Status=0", "R0=0xFFFFFFFF,R1=0,R2=0,Status=Z", "SBCS R2,R1,R0" },
    { TLOC, "SBCS_Zero", "R0=1,Status=0", "R0=1,R1=0xFFFFFFFF,Status=N", "SBCS R1,R0,#1" },
    { TLOC, "SBCS_Negative", "R0=0,Status=0", "R0=0,R1=0xFFFFFFFE,Status=N", "SBCS R1,R0,#1" },

    // RSC
    { TLOC, "RSC_NoFlagsCC", "R0=1,Status=0", "R0=1,R1=0,Status=0", "RSC R1,R0,#2" },
    { TLOC, "RSC_NoFlagsCS", "R0=1,Status=C", "R0=1,R1=2,Status=C", "RSC R1,R0,#3" },
    { TLOC, "RSC_Overflow", "R0=1,Status=0", "R0=1,R1=0x7FFFFFFE,Status=0", "RSC R1,R0,#0x80000000" },
    { TLOC, "RSC_Carry", "R0=0xFFFFFFFF,R1=0,Status=0", "R0=0xFFFFFFFF,R1=0,R2=0,Status=0", "RSC R2,R0,R1" },
    { TLOC, "RSC_Zero", "R0=1,Status=0", "R0=1,R1=0xFFFFFFFF,Status=0", "RSC R1,R0,#1" },
    { TLOC, "RSC_Negative", "R0=1,Status=0", "R0=1,R1=0xFFFFFFFE,Status=0", "RSC R1,R0,#0" },
    { TLOC, "RSCS_NoFlagsCC", "R0=1,Status=0", "R0=1,R1=0,Status=ZC", "RSCS R1,R0,#2" },
    { TLOC, "RSCS_NoFlagsCS", "R0=1,Status=C", "R0=1,R1=2,Status=C", "RSCS R1,R0,#3" },
    { TLOC, "RSCS_Overflow", "R0=1,Status=0", "R0=1,R1=0x7FFFFFFE,Status=CV", "RSCS R1,R0,#0x80000000" },
    { TLOC, "RSCS_Carry", "R0=0xFFFFFFFF,R1=0,Status=0", "R0=0xFFFFFFFF,R1=0,R2=0,Status=Z", "RSCS R2,R0,R1" },
    { TLOC, "RSCS_Zero", "R0=1,Status=0", "R0=1,R1=0xFFFFFFFF,Status=N", "RSCS R1,R0,#1" },
    { TLOC, "RSCS_Negative", "R0=1,Status=0", "R0=1,R1=0xFFFFFFFE,Status=N", "RSCS R1,R0,#0" },

    // CMP
    { TLOC, "CMP_NoFlags", "R0=2,Status=0", "R0=2,Status=C", "CMP R0,#1" },
    { TLOC, "CMP_Overflow", "R0=0x80000000,Status=0", "R0=0x80000000,Status=CV", "CMP R0,#1" },
    { TLOC, "CMP_Carry", "R0=0xFFFFFFFF,R1=0,Status=0", "R0=0xFFFFFFFF,R1=0,Status=0", "CMP R1,R0" },
    { TLOC, "CMP_Zero", "R0=1,Status=0", "R0=1,Status=ZC", "CMP R0,#1" },
    { TLOC, "CMP_Negative", "R0=0,Status=0", "R0=0,Status=N", "CMP R0,#1" },
...
void registerAluExecTests()
{
    ...
    RegisterExecTests<ArmV2TestSystemTraits<false>>("ARMv2_ALU", basicAlu, std::size(basicAlu));
    RegisterExecTests<ArmV2TestSystemTraits<false>>("ARMv2_ALU", basic26BitAlu, std::size(basic26BitAlu));

    // Repeat tests for the ARM 250 core.
    RegisterExecTests<ArmV2aSTestSystemTraits<false>>("ARMv2aS_ALU", basicAlu, std::size(basicAlu));
    RegisterExecTests<ArmV2aSTestSystemTraits<false>>("ARMv2aS_ALU", basic26BitAlu, std::size(basic26BitAlu));

    // Repeat tests for the ARM 3 core.
    RegisterExecTests<ArmV2aTestSystemTraits<false>>("ARMv2a_ALU", basicAlu, std::size(basicAlu));
    RegisterExecTests<ArmV2aTestSystemTraits<false>>("ARMv2a_ALU", basic26BitAlu, std::size(basic26BitAlu));
}
