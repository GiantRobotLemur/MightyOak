...
////////////////////////////////////////////////////////////////////////////////
#define STATIC_SCALAR_DEF(t, x) EnumSymbol<t>(x, # x)
#define STATIC_SCALAR_DEF2(t, x, y) EnumSymbol<t>(x, # x, y)
#define STATIC_SCALAR_DEF3(t, x, y, z) EnumSymbol<t>(x, # x, y, z)
#define STATIC_ENUM_DEF(x) EnumSymbol<decltype(x)>(x, # x)
